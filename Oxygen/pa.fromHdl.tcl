...
create_project -name Oxygen -dir "D:/Work/FPGA Project/SimpleSpace/Oxygen/planAhead_run_4" -part xc6slx9tqg144-3
...
set hdlfile [add_files [list {Oxygen.vhd}]]
set_property file_type VHDL $hdlfile
set_property library work $hdlfile
set_property top Oxygen $srcset
